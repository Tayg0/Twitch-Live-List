...
var templateCard = "<div class=\"col-xs-3 col-stream-info\"><div class=\"card stream-info\"><div class=\"card-body card-body-stream-info\"><h6 class=\"card-title\">{USERNAME}<span class=\"viewers-text\">●387</span></h6><p class=\"card-text\">{TITLE}</p></div></div></div>";
